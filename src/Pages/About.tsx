...
export const About = () => {
    return (
        <>
            <head>
                <title>About, teck Stack, story | Gen Iabichino</title>
            </head>
            <div className="wrapper flex items-center flex-grow">
                <section className="grid gap-y-4 gap-x-6">
                    <div className="col-span-1 md:col-span-3"><div>
                        ...
                        <figure className="gap-6" >
                            ...
                            <p className="mb-4"> What really sparked my interest was the magic behind how things work. So, in 2024, I dove headfirst into coding. It was love at first sight! I'm now a web development enthusiast, with a focus on HTML, CSS, JavaScript, TypeScript, Node.js, Express, React, and Next.js.</p>
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li className="list-tag"><kbd> CSS </kbd></li>
                            <li className="list-tag"><kbd> React</kbd></li>
                            <li className="list-tag"><kbd>TailwindCSS</kbd></li>
                            <li className="list-tag"><kbd>Bootstrap</kbd></li>
                            <li className="list-tag"><kbd>JavaScript</kbd></li>
                            <li className="list-tag"><kbd>Node.js</kbd></li>
                            <li className="list-tag"><kbd>Next.js</kbd></li>
                            <li className="list-tag"><kbd>SQLAlchemy</kbd></li>
                            <li className="list-tag"><kbd>git</kbd></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul>
                            ...
                            <li className="list-tag">JWT</li>
                            <li className="list-tag">SQL</li>
                            <li className="list-tag">Open Ai</li>
                        </ul>
                    </div>
                    <div>
                        <h4>Other tools</h4>
                        <ul>
                            <li className="list-tag">Figma</li>
                            <li className="list-tag">Blender</li>
                            <li className="list-tag">Prototyping</li>
                            <li className="list-tag">Scrum</li>
                        </ul>
